...
@Configurable
@Autonomous(name = "BLUE: Back - 6 + Extra")
public class Auto_BLUE_Back_6_WithExtra extends OpMode {
    ...
    private Supplier<PathChain> farShotPoint, closeShotChain, firstCollectionChain_0, firstCollectionChain_1, secondCollectionChain_0, secondCollectionChain_1, endingChain, customShotPathChain, humanPlayerChain;
...
//        sorter.shift(0);
        ...
        farShotPoint = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(58, 22))))
        ...
        firstCollectionChain_0 = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(48, 38))))
        ...
        firstCollectionChain_1 = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(8, 38))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(180)))
                .build();

        secondCollectionChain_0 = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(48, 59))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(180)))
                .build();
        secondCollectionChain_1 = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(8, 59))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(180)))
                .build();
        ...
        closeShotChain = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierCurve(follower::getPose, new Pose(54, 67))))
                .setHeadingInterpolation(HeadingInterpolator.linearFromPoint(follower::getHeading, Math.toRadians(180), .8))
                .addPath(new Path(new BezierCurve(follower::getPose, new Pose(52, 96))))
                .setHeadingInterpolation(HeadingInterpolator.linearFromPoint(follower::getHeading, Math.toRadians(180), .8))
                .build();

        humanPlayerChain = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(39, 35))))
                .setHeadingInterpolation(HeadingInterpolator.linearFromPoint(follower::getHeading, Math.toRadians(-115), .8))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(19, 20))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-120)))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(14, 20))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-145)))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(14, 16))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-145)))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(14, 20))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-160)))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(14, 8))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-160)))
                .build();
        ...
        switch(pathState) {
            ...
            case 6:
                if (!follower.isBusy()) {
                    shooter.setVelocity("Low");
                    toggleIntake();
                    follower.followPath(humanPlayerChain.get(), true);
                    pathChainTimer = timer.milliseconds();
                    delayTimer[5] = timer.milliseconds();
                    pathState = 7;
            ...
            case 7:
                if (!follower.isBusy() || (timer.milliseconds() - pathChainTimer) >= 10000) {
                    shooter.setVelocity("High");
                    follower.followPath(farShotPoint.get(), true);
                    pathChainTimer = timer.milliseconds();
                    pathState = 8;
...
//
            ...
            case 10:
                if (!follower.isBusy() || (timer.milliseconds() - pathChainTimer) >= 5000) {
                    shooter.setVelocity("High");
                    follower.followPath(farShotPoint.get(), true);
                    pathChainTimer = timer.milliseconds();
                    pathState = 11;
            ...
            case 11:
                if (!follower.isBusy() || ((timer.milliseconds() - pathChainTimer) >= 2000 && (timer.milliseconds() - pathChainTimer) <= 3000)) {
                    intake.slapArtifact();
                }
