...
@Configurable
@Autonomous(name = "BLUE: Front-Leave")
public class Auto_BLUE_FrontLeave extends OpMode {
    ...
    private Supplier<PathChain> closeShotPoint, closeShotChain, firstCollectionChain_0, firstCollectionChain_1, secondCollectionChain_0, secondCollectionChain_1, endingChain, customShotPathChain;
...
//        sorter.shift(0);
        ...
        endingChain = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(57, 108))))
