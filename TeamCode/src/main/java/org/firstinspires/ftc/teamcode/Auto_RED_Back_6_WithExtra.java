...
@Configurable
@Autonomous(name = "RED: Back - 6 + Extra")
public class Auto_RED_Back_6_WithExtra extends OpMode {
    ...
    private Supplier<PathChain> farShotPoint, closeShotPoint, firstCollectionChain_0, firstCollectionChain_1, secondCollectionChain_0, secondCollectionChain_1, endingChain, customShotPathChain, humanPlayerChain;
...
//        sorter.shift(0);
        ...
        humanPlayerChain = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(105, 35))))
                .setHeadingInterpolation(HeadingInterpolator.linearFromPoint(follower::getHeading, Math.toRadians(-15), .8))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(125, 20))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-30)))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(132, 20))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-55)))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(132, 14))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-55)))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(132, 20))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-70)))
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(132, 10))))
                .setHeadingInterpolation(HeadingInterpolator.constant(Math.toRadians(-70)))
                .build();
