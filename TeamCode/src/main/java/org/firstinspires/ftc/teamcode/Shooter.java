...
public class Shooter {
    ...
    private final double[] shooterVel = {1350, 1650, 1350, 1650, 0, 0, 0, 0};
    ...
    public Shooter(HardwareMap map) {
        ...
        shooterFrontPIDF =  new PIDFCoefficients(120, 0, 0, 31); //60,27
    ...
    public double[] computeCustomShotParameters(double global_x, double global_y, String teamColor) {
        ...
        double realOmega = (2 / 0.23622) * (28 / (2 * Math.PI)) * (1 / 0.5) * exitVel; // shot energy transfer efficiency is an estimate of 45%
