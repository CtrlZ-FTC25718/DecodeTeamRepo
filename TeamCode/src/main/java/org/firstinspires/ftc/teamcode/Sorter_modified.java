...
public class Sorter_modified {
    ...
    private static final double sorterZeroPos = 0.0385; // was 0.07
    private double distance;

    private boolean colorSensorEnabled;

    //Constructor
    public Sorter_modified(HardwareMap map){
    ...
    public void enableColorSensor (){this.colorSensorEnabled = true;}
    public void disableColorSensor(){this.colorSensorEnabled = false;}
    public boolean isColorSensorEnabled(){return colorSensorEnabled;}
    ...
    public boolean isSorting(){
        // If sorter is still moving from previous state to next state
        double targetSorterPos = (double) state.get(0);
        Log.d("Manage Sorter","SorterPos" + sorterServo.getPosition());
        return (Math.abs(sorterServo.getPosition() - targetSorterPos) > 0.001);
    }
