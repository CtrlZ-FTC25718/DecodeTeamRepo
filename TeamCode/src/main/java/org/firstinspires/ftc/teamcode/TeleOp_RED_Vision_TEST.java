...
@Configurable
//@TeleOp(name = "RED - Vision - TEST")
public class TeleOp_RED_Vision_TEST extends OpMode {
...
//      startingPose = new Pose(72,8.5, Math.toRadians(90));; //See ExampleAuto to understand how to use this
    ...
    private void shootArtifact (){
        ...
        if (shootArtifactAtHighSpeed){
            sorterDoorWaitTime = 200;
            sorterVaneWaitTime = 200;
        }
        else {
            sorterDoorWaitTime = 0;
            sorterVaneWaitTime = 0;
        }
